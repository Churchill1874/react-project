...
import { Card, Divider, Tag, Image, ImageViewer, Swiper } from 'antd-mobile';
    ...
    <>
      ...
      <Card className="promotion-custom-card-container">
        ...
        <div className="promotion-card-content">
          ...
          <Comment needCommentPoint={props.needCommentPoint} commentPointId={props.commentPointId} setPromotion={setPromotion} newsId={props.id} newsType={4} />
        </div>
      </Card>
