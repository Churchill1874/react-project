...
const Company: React.FC = () => {
    ...
    const southeastAsiaNewsPageRequest = async (isReset: boolean)=>{
        ...
        const resp: SoutheastAsiaNewsType[] = (await SoutheastAsiaNewsPageReq(param)).data.records || [];

        console.log('获取api东南亚新闻数据:' + resp)
        //循环便利
   

        setSoutheastAsiaNewsList(resp);
                                ...
                                <div className="button-info">
                                    ...
                                    <span className="tracking"> 
                                        ...
                                        <span className="click" 
                                            onClick={() => 
                                                {showPopupInfo(southeastAsiaNews.id,southeastAsiaNews.commentCount,
                                                      southeastAsiaNews.content,southeastAsiaNews.readCount,
                                                        southeastAsiaNews.commentCount,southeastAsiaNews.imagePath,
                                                          southeastAsiaNews.createTime, southeastAsiaNews.isHot)}}>点击查看</span> 
                                        </span>
                                    </span>
                                </div> 
                            </div>
