...
import { RedoOutline, BellOutline, BillOutline, ReceiptOutline, CheckShieldOutline } from 'antd-mobile-icons';
import '@/pages/lottery/politicslottery/PoliticsLottery.less';
import { LotteryDealerReq, Request_LotteryDealerPage, LotteryDealerView } from '@/pages/lottery/politicslottery/api'
    ...
    <>
      <div className="filter-header">
        <div className="header-top">
          <span className="title">热门竞猜</span>
          <span className="updated">今日：{dayjs(new Date).format("YYYY-MM-DD ")}</span>
        </div>
                  ...
                  !lottery.choose3 && (
                    <Card className="lottery-card" key={'card2' + lottery.dealerId}>
                      ...
                      <div className="lottery-stats">
                        <div className="deadline">
                          <div className="deadline-text">
                            <div><BellOutline fontSize={14} /> 投注截止:</div>
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.9rem', color: 'gray', margin: '15px 0px' }}>
                        <span >
                          编号: {lottery.dealerId}</span>
                        <div>
                          <div style={{ display: 'flex', alignItems: 'center' }}>参与: {lottery.betCount} </div>
                        </div>
                        <span>开奖: {dayjs(lottery.createTime).format("YYYY-MM-DD")}</span>
                      </div>
                      <Collapse accordion>
